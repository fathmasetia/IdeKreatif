...
<!-- Tabel data kategori -->
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            toggle="modal" data-bs-target="#addCategory">Tambah Kategori</button>
        </div>
</div class="card-body">
</div class="table-responsive text-nowrap">
<table id="datable" class="table table-hover">
    <thead>
    ...
    <tbody class="table-border-bottom-0">
        ...
        <tr>
            ...
            <td>
                <!-- dropdownuntuk opsi edit dan delete -->
                <div class="dropwdown">
                    <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropwdown">
     ...
     <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="proses_kategori.php" methos="POST">
                    <div>
    ...
    <!-- Modal untuk hapus data kategori -->
     ...
     <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="process_kategori.php" method="POST">
                    <div>
